...
<head>
    ...
    <style type="text/css">
        ...
        .icon-event-viewer { background-image: url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="%23000"><path d="M8 2a1 1 0 0 0-1 1v1.586l-1.707-1.707a1 1 0 0 0-1.414 1.414L5.586 6H4a1 1 0 0 0-1 1v4a1 1 0 0 0 1 1h1.586l-1.707 1.707a1 1 0 0 0 1.414 1.414L7 13.414V15a1 1 0 1 0 2 0v-1.586l1.707 1.707a1 1 0 0 0 1.414-1.414L10.414 12H12a1 1 0 0 0 1-1V7a1 1 0 0 0-1-1h-1.586l1.707-1.707a1 1 0 0 0-1.414-1.414L9 4.586V3a1 1 0 0 0-1-1zM8 9.5a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3z"/></svg>'); }
    </style>
</head>
<body>
    <div id="desktop"></div>
